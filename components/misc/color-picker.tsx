...
const ColorArea: React.FC<ColorAreaProps> = ({
    hue,
    saturation,
    lightness,
    onChange,
    ...
    return (
        <div className="relative">
            ...
            {isOpen && (
                <div
                    ref={dropdownRef}
                    className="absolute bottom-full left-0 mb-2 md:bottom-auto md:left-full md:top-1/2 md:-translate-y-1/2 md:ml-2 p-3 bg-white dark:bg-[#151515] rounded-xl border border-gray-200 dark:border-gray-700 shadow-xl z-50 min-w-[260px] md:min-w-[320px]"
                >
